...
<html>
    <head>
        ...
        <meta name="title" content="CONESCAPAN 2015" />
        <meta name="description" content="El Instituto de Ingenieros en Electricidad y Electrónica (IEEE) Sección El Salvador, organiza la Trigésima Cuarta Convención de Estudiantes de Centroamérica y Panamá, CONESCAPAN XXXIV, El Salvador 2015, que es el mayor evento estudiantil de la región que reúne a estudiantes y profesionales de área de la electricidad, electrónica y ramas afines. " />
        <link rel="image_src" href="http://www.conescapan2015.com/assets/img/logo_blanco.png" />
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar-main">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="<?php echo site_url('inicio/inscripciones'); ?>">INSCRIPCIONES</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('inicio/comite_organizador'); ?>">COMIT&Eacute; ORGANIZADOR</a>
                        </li>
                        <li>
                            <a href="#">PROGRAMA</a>
                        </li>
                        ...
                        <li>
                            <a href="<?php echo site_url('inicio/patrocinadores'); ?>">PATROCINIO</a>
                        </li>
                    <!-- </ul> -->

                    <!-- <ul class="nav navbar-nav navbar-right"> -->
                        <li><a href="<?php echo site_url('inicio/hotel_sede'); ?>">HOTEL SEDE</a></li>
                        
                        <li><a href="<?php echo site_url('inicio/contacto'); ?>">CONTACTO</a></li>
                    </ul>
                </div>
            </div>
        </div>